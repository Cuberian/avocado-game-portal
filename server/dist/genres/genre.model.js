...
__decorate([
    sequelize_typescript_1.BelongsToMany(() => game_model_1.Game, () => game_genres_model_1.GameGenres),
    __metadata("design:type", Array)
], Genre.prototype, "genres", void 0);
Genre = __decorate([
    sequelize_typescript_1.Table({ tableName: 'genres' })
], Genre);
exports.Genre = Genre;
